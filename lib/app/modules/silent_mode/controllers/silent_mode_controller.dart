...
class SilentModeController extends GetxController {
  ...
  Future<void> toggleSilentMode(bool value) async {
    ...
    await requestAdvancedSilentMode(value);
  }

  Future<void> requestAdvancedSilentMode(bool value) async {
    print('requestAdvancedSilentMode: $value');
    if (_isUpdating) return;
    _isUpdating = true;
    if (_leoHomeController.connectionState.value !=
        BleConnectionState.connected) {
    ...
    try {
      ...
      _leoHomeController.advancedSilentModeEnabled.value = value;
      _syncFromLeo();
  ...
  void _syncFromLeo() {
    advancedSilentModeEnabled.value =
