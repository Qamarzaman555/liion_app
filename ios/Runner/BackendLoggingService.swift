...
class BackendLoggingService {
    ...
    private func getDeviceLabel() -> String {
        ...
        let modelName = getHumanReadableModelName(from: modelCode ?? "Unknown")
        
        // Sanitize model name: replace spaces with hyphens
        let sanitizedModel = modelName.replacingOccurrences(of: " ", with: "-")
        
        // Sanitize device name: replace spaces and special characters with hyphens
        ...
        let sanitizedDeviceName = deviceName
            ...
            .replacingOccurrences(of: "\t", with: "")
            .replacingOccurrences(of: "--", with: "-") // Replace double hyphens
            .trimmingCharacters(in: CharacterSet(charactersIn: "-"))
        
        let iosVersion = UIDevice.current.systemVersion
        
        return "\(sanitizedDeviceName)-\(sanitizedModel)-\(iosVersion)"
    }
    
    private func getHumanReadableModelName(from modelCode: String) -> String {
